...
symbols = [
    Symbol("`", ["back tick", "bee tick"], ["grave"]), # Krysl 2026
    Symbol(",", ["comma", "coma"]),
    Symbol(".", ["period", "full stop"], ["dot", "point"]),
    Symbol(";", ["semicolon", "wink"], ["semi"]), # Krysl 2026
    Symbol(":", ["colon"]),
    Symbol("?", ["question mark", "quest"], ["question"]), # Krysl 2026
    Symbol("!", ["exclamation mark", "exclamation point"], ["bang"]),
    Symbol("*", ["asterisk"], ["star"]),
    Symbol("#", ["hash sign", "number sign", "sharp"], ["hash"]), # Krysl 2026
    Symbol("%", ["percent sign", "percy"], ["percent"]), # Krysl 2026
    Symbol("@", ["at symbol", "at sign", "swirl"]), # Krysl 2026
    ...
    Symbol("]", None, ["R brack", "R bracket", "right bracket", "R square", "right square", "close square"]), # Krysl 2026
    Symbol("/", ["forward slash"], ["slash"]),
    Symbol("\\", None, ["backslash", "whack"]), # Krysl 2026
    Symbol("{", None, ["brace", "L brace", "left brace", "curly bracket", "left curly bracket", "open curly"],), # Krysl 2026
    Symbol("}", None, ["R brace", "right brace","R curly bracket", "right curly bracket", "close curly"]), # Krysl 2026
    Symbol("<", None, ["angle", "L Angle", "left angle", "less than", "open fork"]), # Krysl 2026   
    Symbol(">", None, ["rangle", "R angle", "right angle", "greater than", "close fork"]), # Krysl 2026
    Symbol("^", None, ["caret", "hat"]),
    Symbol("|", None, ["pipe"]),
    Symbol("'", None, ["quote", "apostrophe", "trophy"]), # Krysl 2026
